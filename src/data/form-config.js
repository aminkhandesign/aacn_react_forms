const myConfig =
    [
        "Mailing Address",
        [
            { type: ["input"], label: "Company", placeholder: "Company name", validate: true, field: "name" },
            ...
            { type: ["select", ["UNITED STATES", "UNITED KINGDOM"]], label: "Country", placeholder: "country", validate: false, field: "country" }            
        ]
    ];
